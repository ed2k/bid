# ddimp with the 12 double/redouble flips reverted to the control
#   isolates the effect of X/XX: every other changed call is identical

# ---- merged from 3 slice files ----

#   only_open.dsl                (no provenance)

#   s330_laterU_ddimp.dsl        traces     data/brill_traces_330k.jsonl  (77882 rows featurised)  |  group      opening_contested   [slice False,False]  |  depth      10    min-samples 25    folds 2
